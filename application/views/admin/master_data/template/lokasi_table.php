<html>	
	...
	<body>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablecb overviewtable2">
					...
					<tbody>
						{{#if results}}
							{{#each results}}
							<tr id="{{id_lokasi}}">
								<td class="chkbox"><input type="checkbox" class="chkbox-input" value="{{id_lokasi}}"/></td>
								<td>{{kode_lokasi}}</td>                                                                                   
								<td>{{nama}}</td>                                                                                   
								<td>
									{{#ifCond status '==' 1}}
		...
		<form method="POST" action="#" id="form-hidden-filter" class="hidden">
			<input type="hidden" name="kode_lokasi" id="f_kode_lokasi" value="<?php echo $kode_lokasi?>"/>
		...
		<script>
			...
			var url = "admin/master_data/lokasi_table/";	
