<html>	
	...
	<body>
				...
				<table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablecb overviewtable2">
					...
					<thead>
						<tr>
							...
							<th class="head0">ID Mekanik</th>
							<th class="head1">Nama</th>
							<th class="head0">Nomor Pit</th>
		...
		<form method="POST" action="#" id="form-hidden-filter" class="hidden">
			...
			<input type="hidden" name="id_barang" value="<?php echo htmlspecialchars($pit_no);?>"/>
		</form>
		...
		<script>
			...
			var url = "admin/report/mekanik_table/";	
