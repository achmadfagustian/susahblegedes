	...
	<script>
		...
		var refresh_table_url = "<?php echo site_url('admin/user/kasir_table_index')?>";
		var dialog_save_url = "<?php echo site_url('admin/user/kasir_save')?>";
		var multiple_del_url = "<?php echo site_url('admin/user/kasir_multi_delete')?>";
		var get_data_url = "<?php echo site_url('admin/user/kasir_get_data')?>/";
		
		var attr_add = {title: "Tambah Kasir"};
		var attr_edit = {title: "Ubah Kasir"};
		var attr_search = {title: "Cari Kasir"};
		var width_form = 600;
		var height_form = 590;
