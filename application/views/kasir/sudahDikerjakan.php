	...
	<div class="vernav iconmenu">
    	<ul>
            ...
            <li class="current"><a href="<?php echo site_url('kasir/sudahDikerjakan')?>" class="sent">Sudah Di kerjakan</a></li>
			<li><a href="<?php echo site_url('kasir/cancel')?>" class="sent">Cancel</a></li>
        </ul>
			...
			<table cellpadding="0" cellspacing="0" border="0" class="stdtable stdtablecb overviewtable2">
				...
				<thead>
					<tr>
						...
						<th class="head0">Waktu Selesai Pengerjaan</th>
					</tr>
				</thead>
				<tbody>
					<tr>
