			...
			<div class="loginf">
				<div class="thumb"><img alt="" src="images/thumbs/avatar1.png" />
					<div class="userlogged">
						<a href="<?php echo site_url('login/logout')?>">Not <span><?php echo $this->session->userdata('dispname')?></span> ?</a> 
					</div>
				</div>
			</div><!--loginf-->
			<?php }else{?>
            <form id="login" action="<?php echo base_url('login/do_login')?>" method="post">
                <div class="username">
